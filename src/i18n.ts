...
const TRANSLATIONS = {
    en: {
        ...
        'levelSelect.location.vendorPlaza': 'Vendor Plaza — riverside market full of treats',
        'levelSelect.location.ribbonAlley': 'Ribbon Alley — lantern-lit streets and candy shacks',
        'levelSelect.location.lanternBridge': 'Lantern Bridge — bridges glowing with festive lights',
        'levelSelect.location.festival':
            'Festival Grounds — the final showdown where fireworks light the sky',
        'levelSelect.act.setup': 'Act 1 — Setup',
        'levelSelect.act.progression': 'Act 2 — Progression',
        'levelSelect.act.finale': 'Act 3 — Finale',
        'levelSelect.playButton': 'Play level',
        'levelSelect.playButtonLabel': 'Play level {level}',
        'levelSelect.closeDetails': 'Close level details',
        ...
        'mira.evaluation.legendary.0': 'The festival will remember this!',
        'mira.evaluation.legendary.1': 'A cascade worthy of the grand finale!',
        'mira.evaluation.legendary.2': 'Even the lanterns are blushing!',
        'mira.evaluation.epic.0': 'The crowd goes wild!',
        'mira.evaluation.epic.1': 'Sugar magic at its finest!',
        'mira.evaluation.epic.2': 'That one shook the whole plaza!',
        'mira.evaluation.great.0': 'Now we are cooking with caramel!',
        'mira.evaluation.great.1': 'The candies dance for you!',
        'mira.evaluation.great.2': 'Sweet precision!',
        'mira.evaluation.good.0': 'Nicely done, keep the rhythm!',
        'mira.evaluation.good.1': 'The sugar is flowing!',
        'mira.evaluation.good.2': 'A spark of sweetness!',
        'mira.evaluation.decent.0': 'Every burst counts!',
        'mira.evaluation.decent.1': 'Building momentum!',
        'mira.evaluation.decent.2': 'The sweets are listening!',
        ...
        'recording.mode.powerup.shuffle': '🔀 shuffle powerup',
        'recording.mode.powerup.swap': '🔁 swap powerup',
        'recording.mode.powerup.bomb': '💣 bomb powerup',
        ...
        'result.coins.collected': 'Collected +{coins}',
        'result.coins.levelBonus': '(+{bonus} for level completion!)',
        ...
        'shop.section.permanent': 'Permanent',
        'shop.section.consumable': 'Consumable',
        ...
        'shop.feedback.extraSlotOwned': 'Extra powerup slot already unlocked.',
        'shop.extraSlot.label': 'Extra powerup slot',
        'shop.extraSlot.description': 'Unlock a second slot for every tactical powerup.',
        ...
        'tutorial.mechanics.hardeningTitle': 'Hardening candy',
        'tutorial.mechanics.hardeningText': 'Ignored turns build a thick border that turns it into hard candy.',
        ...
        'goal.collectItems': 'Collect {target} delivery items',
        'color.red': 'red',
        'color.amber': 'amber',
        'color.blue': 'blue',
        'color.purple': 'purple',
    ...
    de: {
        ...
        'levelSelect.selectedTitle': 'Level {level}',
        'levelSelect.metaMoves': '{moves} Züge',
        ...
        'levelSelect.location.vendorPlaza': 'Verkäuferplatz – ein geschäftiger Markt am Fluss',
        'levelSelect.location.ribbonAlley': 'Bandgasse – Laternenlichter und Süßigkeitenbuden',
        'levelSelect.location.lanternBridge': 'Laternenbrücke – Brücken leuchten im Festtagsglanz',
        'levelSelect.location.festival': 'Festivalgelände – das große Finale unter Feuerwerk',
        'levelSelect.act.setup': 'Akt 1 – Auftakt',
        'levelSelect.act.progression': 'Akt 2 – Fortschritt',
        'levelSelect.act.finale': 'Akt 3 – Finale',
        'levelSelect.playButton': 'Level starten',
        'levelSelect.playButtonLabel': 'Level {level} starten',
        'levelSelect.closeDetails': 'Level-Details schließen',
        ...
        'mira.evaluation.legendary.0': 'Das Festival wird sich daran erinnern!',
        'mira.evaluation.legendary.1': 'Eine Kaskade würdig des großen Finales!',
        'mira.evaluation.legendary.2': 'Selbst die Laternen erröten!',
        'mira.evaluation.epic.0': 'Die Menge tobt!',
        'mira.evaluation.epic.1': 'Zuckermagie vom Feinsten!',
        'mira.evaluation.epic.2': 'Das hat den ganzen Platz erschüttert!',
        'mira.evaluation.great.0': 'Jetzt kochen wir mit Karamell!',
        'mira.evaluation.great.1': 'Die Bonbons tanzen für dich!',
        'mira.evaluation.great.2': 'Süße Präzision!',
        'mira.evaluation.good.0': 'Gut gemacht, halte den Rhythmus!',
        'mira.evaluation.good.1': 'Der Zucker fließt!',
        'mira.evaluation.good.2': 'Ein Funke Süße!',
        'mira.evaluation.decent.0': 'Jede Explosion zählt!',
        'mira.evaluation.decent.1': 'Schwung aufbauen!',
        'mira.evaluation.decent.2': 'Die Süßigkeiten hören zu!',
        'recording.title': 'Aufzeichnung',
        'recording.close': 'Schließen',
        'recording.label.none': 'Keine Beschr.',
        'recording.label.axis': 'Achse',
        'recording.label.cell': 'Zellen',
        'recording.control.prev': 'Zurück',
        'recording.control.next': 'Weiter',
        'recording.control.auto': 'Auto',
        'recording.control.pause': 'Pause',
        'recording.mode.manual': 'manuell',
        'recording.mode.auto': 'auto',
        'recording.mode.powerup.shuffle': '🔀 Shuffle',
        'recording.mode.powerup.swap': '🔁 Swap',
        'recording.mode.powerup.bomb': '💣 Bombe',
        ...
        'result.coins.collected': 'Gesammelt +{coins}',
        'result.coins.levelBonus': '(+{bonus} für den Levelabschluss!)',
        ...
        'shop.section.permanent': 'Permanent',
        'shop.section.consumable': 'Verbrauchbar',
        'shop.ownedLabel': 'Besessen:',
        'shop.count': 'Besessen: {count}/{max}',
        'shop.price': '{price}',
        'shop.priceAria': 'Preis: {price} Zuckermünzen',
        ...
        'shop.feedback.extraSlotOwned': 'Zusätzlicher Powerup-Slot ist bereits freigeschaltet.',
        'shop.extraSlot.label': 'Zusätzlicher Powerup-Slot',
        'shop.extraSlot.description': 'Schaltet einen zweiten Slot für jedes taktische Powerup frei.',
        'tutorial.title': 'Candy Guide',
        ...
        'tutorial.bombMatches.comboText': 'Kombiniere Bomben für eine größere Explosion.',
        ...
        'tutorial.bombMatches.lineLargeTitle': 'Linienbombe + Große Explosionsbombe',
        ...
        'tutorial.bombMatches.smallLargeTitle': 'Kleine Explosionsbombe + Große Explosionsbombe',
        ...
        'tutorial.mechanics.hardeningTitle': 'Haertendes Bonbon',
        'tutorial.mechanics.hardeningText': 'Ignorierte Zuege bauen einen dicken Rand auf, bis es hart wird.',
        ...
        'goal.destroyHardCandies': 'Zerstöre {target} harte Bonbons',
        'goal.activateBooster': 'Aktiviere {target} {booster}',
        'goal.collectItems': 'Sammle {target} Lieferobjekte',
        'color.red': 'rote',
        'color.amber': 'gelbe',
        'color.blue': 'blaue',
